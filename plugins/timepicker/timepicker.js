$(document).ready(function() {
    ...
    function setupPickerHeader() {
        var header = $('<div class="picker-header"><h5>Time Picker</h5></div>');
    ...
    function setupHourCol() {
        ...
        var hourButtonUp = $('<button value="1" tabindex="-1" type="button" class="hour-picker-button button picker-button">+1</button>');
        var hourPicker = $('<input class="hour-picker picker picker-input" type="number" value="' + initialHour + '" min="1" max="12"/>');
        var hourButtonDown = $('<button value="-1" tabindex="-1" type="button" class="hour-picker-button button picker-button">-1</button>');
    ...
    function setupMinuteCol() {
        ...
        var minuteButtonUp = $('<button value="1" tabindex="-1" type="button" class="minute-picker-button button picker-button">+1</button>');
        var minutePicker = $('<input class="minute-picker picker picker-input" type="number" value="' + initialMinute + '" min="0" max="59"/>');
        var minuteButtonDown = $('<button value="-1" tabindex="-1" type="button" class="minute-picker-button button picker-button">-1</button>');
    ...
    function setupPeriodCol() {
        ...
        if(initialPeriod === "AM") {
            var periodPicker = $('<select class="period-picker picker-input"><option value="0">AM</option><option value="12">PM</option></select>');    
        } else {
            var periodPicker = $('<select class="period-picker picker-input"><option value="0">AM</option><option selected value="12">PM</option></select>');
        }
    ...
    function setupButtonRow() {
        ...
        var submitButton = $('<button type="button" class="submission-button picker-button submit">Pick</button>');
        var cancelButton = $('<button type="button" class="submission-button picker-button cancel">Cancel</button>');
